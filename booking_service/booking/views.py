...
def get_booking_list(request):
    try:
        ...
        return paginator.get_paginated_response(serializer.data)  # use the paginator's response method, it returns the orderDict of list, which contains all the infor
    except Exception as e:
        return Response({'error': str(e)}, status=status.HTTP_400_BAD_REQUEST)
